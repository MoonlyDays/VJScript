...
declare class CConVars {
     ...
     */
    public GetBool(name: ConVarNames): boolean;
     ...
     * @param entindex
     */
    public GetClientConvarValue(name: ConVarNames, entindex: number): string | null;

    /**
     * Returns the convar as an int. May return null if no such convar.
     * @param name
     */
    public GetInt(name: ConVarNames): number | null;

    /**
     * Returns the convar as a string. May return null if no such convar.
     * @param name
     */
    public GetStr(name: ConVarNames): string | null;

    /**
     * Returns the convar as a float. May return null if no such convar.
     * @param name
     */
    public GetFloat(name: ConVarNames): number | null;
     ...
     * @param name
     */
    public IsConVarOnAllowList(name: ConVarNames): boolean;
     ...
     * @param value
     */
    public SetValue(name: ConVarNames, value: unknown): void;
}

/**
 * Provides an interface to read and change the values of console variables.
 */
declare const Convars: CConVars;
...
declare type ClientConVarNames =
    'cl_autoreload' |
    'cl_autorezoom' |
    'cl_flipviewmodels' |
    'cl_language' |
