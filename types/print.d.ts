 ...
 * @constructor
 */
export function ClientPrint(player: CBasePlayer, destination: number, message: string): void;

/**
 * Draw a debug overlay box.
 */
export function DebugDrawBox(origin: Vector, min: Vector, max: Vector, r: number, g: number, b: number, alpha: number, duration: number): void;

/**
 * Draw a debug oriented box (cent, min, max, angles(p,y,r), vRgb, a, duration).
 */
export function DebugDrawBoxAngles(origin: Vector, min: Vector, max: Vector, direction: QAngle, rgb: Vector, alpha: number, duration: number): void;

/**
 * Draw a debug forward box.
 */
export function DebugDrawBoxDirection(center: Vector, min: Vector, max: Vector, forward: Vector, rgb: Vector, alpha: number, duration: number): void;

/**
 * Draw a debug circle.
 */
export function DebugDrawCircle(center: Vector, rgb: Vector, alpha: number, radius: number, ztest: boolean, duration: number): void;
 ...
 */
export function DebugDrawLine(start: Vector, end: Vector, red: number, green: number, blue: number, zTest: boolean, time: number): void;

/**
 * Draw a debug line using color vec.
 */
export function DebugDrawLine_vCol(start: Vector, end: Vector, rgb: Vector, ztest: boolean, duration: number): void;
 ...
 */
export function DebugDrawText(origin: Vector, text: string, useViewCheck: boolean, duration: number): void;
 ...
 */
export function __DumpScope(indentation: number, scope: NutTable): void;

/**
 * Dumps information about a class or instance.
 */
export function DumpObject(object: object): void;
 ...
 */
export function printl(message: string): void;

/**
 * Identical to print. print seems to be a wrapper for this.
 */
export function realPrint(message: string): void;
 ...
 * @param teamOnly
 */
export function Say(player: CBasePlayer, message: string, teamOnly: boolean): void;
